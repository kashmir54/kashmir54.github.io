...
categories: [flipper]
date: 2023-03-10
description: FlipperZero addons by Kashmir54
...
We all know about this little RF swiss tool which flooded the internet with videos and tutorials on Twitter and Youtube. This little device is capable of great things in many RF scenarios, SubGHz, NFC, 125kHz RFID, Infrared and other external modules of you own developement. Since there are many GPIO apps and module extensions being developed by the community, I decided to design some PCBs to connect the different modules to the flipper, instead of having dangling cables all over the place. At the moment I only prepared a PCB for the same purpose, connecting NRF24 and CC1101.
...
The board that I've designed has the same pinout required for the official SubGHz application to use the external module, therefore, you can use the same board for the NRF24 and the CC1101! 

...
This time RsaCtfTool didn't worked for me. I start thinking about doing it myself using [factordb]() and it worked, seems to be a multi-prime RSA, so I used a library to call factordb from python adn obtained the flag:
